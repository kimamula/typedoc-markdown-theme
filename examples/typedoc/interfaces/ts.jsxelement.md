...
### Properties
* [_expressionBrand](ts.jsxelement.md#_expressionbrand)
* [_leftHandSideExpressionBrand](ts.jsxelement.md#_lefthandsideexpressionbrand)
* [_memberExpressionBrand](ts.jsxelement.md#_memberexpressionbrand)
* [_postfixExpressionBrand](ts.jsxelement.md#_postfixexpressionbrand)
* [_primaryExpressionBrand](ts.jsxelement.md#_primaryexpressionbrand)
* [_unaryExpressionBrand](ts.jsxelement.md#_unaryexpressionbrand)
* [children](ts.jsxelement.md#children)
* [closingElement](ts.jsxelement.md#closingelement)
* [contextualType](ts.jsxelement.md#contextualtype)
* [decorators](ts.jsxelement.md#decorators)
* [end](ts.jsxelement.md#end)
* [flags](ts.jsxelement.md#flags)
* [id](ts.jsxelement.md#id)
* [jsDocComment](ts.jsxelement.md#jsdoccomment)
* [kind](ts.jsxelement.md#kind)
* [localSymbol](ts.jsxelement.md#localsymbol)
* [locals](ts.jsxelement.md#locals)
* [modifiers](ts.jsxelement.md#modifiers)
* [nextContainer](ts.jsxelement.md#nextcontainer)
* [openingElement](ts.jsxelement.md#openingelement)
* [parent](ts.jsxelement.md#parent)
* [parserContextFlags](ts.jsxelement.md#parsercontextflags)
* [pos](ts.jsxelement.md#pos)
* [symbol](ts.jsxelement.md#symbol)
...
### children: [NodeArray](ts.nodearray.md)<[JsxChild](../modules/ts.md#jsxchild)>

* Defined in [lib/typescript/tsc.d.ts:651](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L651)


### closingElement: [JsxClosingElement](ts.jsxclosingelement.md)

* Defined in [lib/typescript/tsc.d.ts:652](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L652)
...
### openingElement: [JsxOpeningElement](ts.jsxopeningelement.md)

* Defined in [lib/typescript/tsc.d.ts:650](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L650)
