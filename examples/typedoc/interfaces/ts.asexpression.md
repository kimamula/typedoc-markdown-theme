...
### Properties
* [_expressionBrand](ts.asexpression.md#_expressionbrand)
* [contextualType](ts.asexpression.md#contextualtype)
* [decorators](ts.asexpression.md#decorators)
* [end](ts.asexpression.md#end)
* [expression](ts.asexpression.md#expression)
* [flags](ts.asexpression.md#flags)
* [id](ts.asexpression.md#id)
* [jsDocComment](ts.asexpression.md#jsdoccomment)
* [kind](ts.asexpression.md#kind)
* [localSymbol](ts.asexpression.md#localsymbol)
* [locals](ts.asexpression.md#locals)
* [modifiers](ts.asexpression.md#modifiers)
* [nextContainer](ts.asexpression.md#nextcontainer)
* [parent](ts.asexpression.md#parent)
* [parserContextFlags](ts.asexpression.md#parsercontextflags)
* [pos](ts.asexpression.md#pos)
* [symbol](ts.asexpression.md#symbol)
* [type](ts.asexpression.md#type)
...
* Defined in [lib/typescript/tsc.d.ts:641](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L641)
...
* Defined in [lib/typescript/tsc.d.ts:642](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L642)
