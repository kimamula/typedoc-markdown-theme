...
### Properties
* [_statementBrand](ts.forinstatement.md#_statementbrand)
* [decorators](ts.forinstatement.md#decorators)
* [end](ts.forinstatement.md#end)
* [expression](ts.forinstatement.md#expression)
* [flags](ts.forinstatement.md#flags)
* [id](ts.forinstatement.md#id)
* [initializer](ts.forinstatement.md#initializer)
* [jsDocComment](ts.forinstatement.md#jsdoccomment)
* [kind](ts.forinstatement.md#kind)
* [localSymbol](ts.forinstatement.md#localsymbol)
* [locals](ts.forinstatement.md#locals)
* [modifiers](ts.forinstatement.md#modifiers)
* [nextContainer](ts.forinstatement.md#nextcontainer)
* [parent](ts.forinstatement.md#parent)
* [parserContextFlags](ts.forinstatement.md#parsercontextflags)
* [pos](ts.forinstatement.md#pos)
* [statement](ts.forinstatement.md#statement)
* [symbol](ts.forinstatement.md#symbol)
...
* Defined in [lib/typescript/tsc.d.ts:713](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L713)
...
### initializer: [VariableDeclarationList](ts.variabledeclarationlist.md) | [Expression](ts.expression.md)

* Defined in [lib/typescript/tsc.d.ts:712](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L712)
