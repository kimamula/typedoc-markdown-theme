...
### Properties
* [decorators](ts.templatespan.md#decorators)
* [end](ts.templatespan.md#end)
* [expression](ts.templatespan.md#expression)
* [flags](ts.templatespan.md#flags)
* [id](ts.templatespan.md#id)
* [jsDocComment](ts.templatespan.md#jsdoccomment)
* [kind](ts.templatespan.md#kind)
* [literal](ts.templatespan.md#literal)
* [localSymbol](ts.templatespan.md#localsymbol)
* [locals](ts.templatespan.md#locals)
* [modifiers](ts.templatespan.md#modifiers)
* [nextContainer](ts.templatespan.md#nextcontainer)
* [parent](ts.templatespan.md#parent)
* [parserContextFlags](ts.templatespan.md#parsercontextflags)
* [pos](ts.templatespan.md#pos)
* [symbol](ts.templatespan.md#symbol)
...
* Defined in [lib/typescript/tsc.d.ts:600](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L600)
...
### literal: [LiteralExpression](ts.literalexpression.md)

* Defined in [lib/typescript/tsc.d.ts:601](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L601)
