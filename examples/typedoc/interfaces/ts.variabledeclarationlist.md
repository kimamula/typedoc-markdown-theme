...
### Properties
* [declarations](ts.variabledeclarationlist.md#declarations)
* [decorators](ts.variabledeclarationlist.md#decorators)
* [end](ts.variabledeclarationlist.md#end)
* [flags](ts.variabledeclarationlist.md#flags)
* [id](ts.variabledeclarationlist.md#id)
* [jsDocComment](ts.variabledeclarationlist.md#jsdoccomment)
* [kind](ts.variabledeclarationlist.md#kind)
* [localSymbol](ts.variabledeclarationlist.md#localsymbol)
* [locals](ts.variabledeclarationlist.md#locals)
* [modifiers](ts.variabledeclarationlist.md#modifiers)
* [nextContainer](ts.variabledeclarationlist.md#nextcontainer)
* [parent](ts.variabledeclarationlist.md#parent)
* [parserContextFlags](ts.variabledeclarationlist.md#parsercontextflags)
* [pos](ts.variabledeclarationlist.md#pos)
* [symbol](ts.variabledeclarationlist.md#symbol)

## Properties

### declarations: [NodeArray](ts.nodearray.md)<[VariableDeclaration](ts.variabledeclaration.md)>

* Defined in [lib/typescript/tsc.d.ts:418](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L418)
