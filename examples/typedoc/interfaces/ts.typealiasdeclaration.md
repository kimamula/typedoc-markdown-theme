...
### Properties
* [_declarationBrand](ts.typealiasdeclaration.md#_declarationbrand)
* [_statementBrand](ts.typealiasdeclaration.md#_statementbrand)
* [decorators](ts.typealiasdeclaration.md#decorators)
* [end](ts.typealiasdeclaration.md#end)
* [flags](ts.typealiasdeclaration.md#flags)
* [id](ts.typealiasdeclaration.md#id)
* [jsDocComment](ts.typealiasdeclaration.md#jsdoccomment)
* [kind](ts.typealiasdeclaration.md#kind)
* [localSymbol](ts.typealiasdeclaration.md#localsymbol)
* [locals](ts.typealiasdeclaration.md#locals)
* [modifiers](ts.typealiasdeclaration.md#modifiers)
* [name](ts.typealiasdeclaration.md#name)
* [nextContainer](ts.typealiasdeclaration.md#nextcontainer)
* [parent](ts.typealiasdeclaration.md#parent)
* [parserContextFlags](ts.typealiasdeclaration.md#parsercontextflags)
* [pos](ts.typealiasdeclaration.md#pos)
* [symbol](ts.typealiasdeclaration.md#symbol)
* [type](ts.typealiasdeclaration.md#type)
* [typeParameters](ts.typealiasdeclaration.md#typeparameters)
...
* Defined in [lib/typescript/tsc.d.ts:784](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L784)
...
### type: [TypeNode](ts.typenode.md)

* Defined in [lib/typescript/tsc.d.ts:786](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L786)


### Optional typeParameters: [NodeArray](ts.nodearray.md)<[TypeParameterDeclaration](ts.typeparameterdeclaration.md)>

* Defined in [lib/typescript/tsc.d.ts:785](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L785)
