...
### Extends
* [UnionOrIntersectionTypeNode](ts.unionorintersectiontypenode.md)

## Index

### Properties
* [_typeNodeBrand](ts.intersectiontypenode.md#_typenodebrand)
* [decorators](ts.intersectiontypenode.md#decorators)
* [end](ts.intersectiontypenode.md#end)
* [flags](ts.intersectiontypenode.md#flags)
* [id](ts.intersectiontypenode.md#id)
* [jsDocComment](ts.intersectiontypenode.md#jsdoccomment)
* [kind](ts.intersectiontypenode.md#kind)
* [localSymbol](ts.intersectiontypenode.md#localsymbol)
* [locals](ts.intersectiontypenode.md#locals)
* [modifiers](ts.intersectiontypenode.md#modifiers)
* [nextContainer](ts.intersectiontypenode.md#nextcontainer)
* [parent](ts.intersectiontypenode.md#parent)
* [parserContextFlags](ts.intersectiontypenode.md#parsercontextflags)
* [pos](ts.intersectiontypenode.md#pos)
* [symbol](ts.intersectiontypenode.md#symbol)
* [types](ts.intersectiontypenode.md#types)
...
### types: [NodeArray](ts.nodearray.md)<[TypeNode](ts.typenode.md)>

* Inherited from [UnionOrIntersectionTypeNode](ts.unionorintersectiontypenode.md).[types](ts.unionorintersectiontypenode.md#types)
* Defined in [lib/typescript/tsc.d.ts:516](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L516)
