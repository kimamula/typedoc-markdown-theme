...
### Properties
* [_typeNodeBrand](ts.tupletypenode.md#_typenodebrand)
* [decorators](ts.tupletypenode.md#decorators)
* [elementTypes](ts.tupletypenode.md#elementtypes)
* [end](ts.tupletypenode.md#end)
* [flags](ts.tupletypenode.md#flags)
* [id](ts.tupletypenode.md#id)
* [jsDocComment](ts.tupletypenode.md#jsdoccomment)
* [kind](ts.tupletypenode.md#kind)
* [localSymbol](ts.tupletypenode.md#localsymbol)
* [locals](ts.tupletypenode.md#locals)
* [modifiers](ts.tupletypenode.md#modifiers)
* [nextContainer](ts.tupletypenode.md#nextcontainer)
* [parent](ts.tupletypenode.md#parent)
* [parserContextFlags](ts.tupletypenode.md#parsercontextflags)
* [pos](ts.tupletypenode.md#pos)
* [symbol](ts.tupletypenode.md#symbol)
...
### elementTypes: [NodeArray](ts.nodearray.md)<[TypeNode](ts.typenode.md)>

* Defined in [lib/typescript/tsc.d.ts:513](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L513)
