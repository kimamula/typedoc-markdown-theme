...
### Properties
* [_expressionBrand](ts.templateexpression.md#_expressionbrand)
* [_leftHandSideExpressionBrand](ts.templateexpression.md#_lefthandsideexpressionbrand)
* [_memberExpressionBrand](ts.templateexpression.md#_memberexpressionbrand)
* [_postfixExpressionBrand](ts.templateexpression.md#_postfixexpressionbrand)
* [_primaryExpressionBrand](ts.templateexpression.md#_primaryexpressionbrand)
* [_unaryExpressionBrand](ts.templateexpression.md#_unaryexpressionbrand)
* [contextualType](ts.templateexpression.md#contextualtype)
* [decorators](ts.templateexpression.md#decorators)
* [end](ts.templateexpression.md#end)
* [flags](ts.templateexpression.md#flags)
* [head](ts.templateexpression.md#head)
* [id](ts.templateexpression.md#id)
* [jsDocComment](ts.templateexpression.md#jsdoccomment)
* [kind](ts.templateexpression.md#kind)
* [localSymbol](ts.templateexpression.md#localsymbol)
* [locals](ts.templateexpression.md#locals)
* [modifiers](ts.templateexpression.md#modifiers)
* [nextContainer](ts.templateexpression.md#nextcontainer)
* [parent](ts.templateexpression.md#parent)
* [parserContextFlags](ts.templateexpression.md#parsercontextflags)
* [pos](ts.templateexpression.md#pos)
* [symbol](ts.templateexpression.md#symbol)
* [templateSpans](ts.templateexpression.md#templatespans)
...
### head: [LiteralExpression](ts.literalexpression.md)

* Defined in [lib/typescript/tsc.d.ts:596](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L596)
...
### templateSpans: [NodeArray](ts.nodearray.md)<[TemplateSpan](ts.templatespan.md)>

* Defined in [lib/typescript/tsc.d.ts:597](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L597)
