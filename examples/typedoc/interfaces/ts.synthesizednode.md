...
### Properties
* [decorators](ts.synthesizednode.md#decorators)
* [end](ts.synthesizednode.md#end)
* [flags](ts.synthesizednode.md#flags)
* [id](ts.synthesizednode.md#id)
* [jsDocComment](ts.synthesizednode.md#jsdoccomment)
* [kind](ts.synthesizednode.md#kind)
* [leadingCommentRanges](ts.synthesizednode.md#leadingcommentranges)
* [localSymbol](ts.synthesizednode.md#localsymbol)
* [locals](ts.synthesizednode.md#locals)
* [modifiers](ts.synthesizednode.md#modifiers)
* [nextContainer](ts.synthesizednode.md#nextcontainer)
* [parent](ts.synthesizednode.md#parent)
* [parserContextFlags](ts.synthesizednode.md#parsercontextflags)
* [pos](ts.synthesizednode.md#pos)
* [startsOnNewLine](ts.synthesizednode.md#startsonnewline)
* [symbol](ts.synthesizednode.md#symbol)
* [trailingCommentRanges](ts.synthesizednode.md#trailingcommentranges)
...
### Optional leadingCommentRanges: [CommentRange](ts.commentrange.md)[]

* Defined in [lib/typescript/tsc.d.ts:4947](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L4947)
...
* Defined in [lib/typescript/tsc.d.ts:4949](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L4949)
...
### Optional trailingCommentRanges: [CommentRange](ts.commentrange.md)[]

* Defined in [lib/typescript/tsc.d.ts:4948](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L4948)
