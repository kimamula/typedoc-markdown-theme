...
### Properties
* [Socket](_tty_.writestream.md#socket)
...
* [remoteAddress](_tty_.writestream.md#remoteaddress)
* [remoteFamily](_tty_.writestream.md#remotefamily)
* [remotePort](_tty_.writestream.md#remoteport)
...
### new WriteStream(opts?: [DuplexOptions](_stream_.duplexoptions.md)): [WriteStream](_tty_.writestream.md)
...
* Defined in [lib/node/node.d.ts:1385](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/node/node.d.ts#L1385)
...
* Defined in [lib/node/node.d.ts:1386](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/node/node.d.ts#L1386)
