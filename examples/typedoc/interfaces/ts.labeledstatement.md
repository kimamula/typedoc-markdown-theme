...
### Properties
* [_statementBrand](ts.labeledstatement.md#_statementbrand)
* [decorators](ts.labeledstatement.md#decorators)
* [end](ts.labeledstatement.md#end)
* [flags](ts.labeledstatement.md#flags)
* [id](ts.labeledstatement.md#id)
* [jsDocComment](ts.labeledstatement.md#jsdoccomment)
* [kind](ts.labeledstatement.md#kind)
* [label](ts.labeledstatement.md#label)
* [localSymbol](ts.labeledstatement.md#localsymbol)
* [locals](ts.labeledstatement.md#locals)
* [modifiers](ts.labeledstatement.md#modifiers)
* [nextContainer](ts.labeledstatement.md#nextcontainer)
* [parent](ts.labeledstatement.md#parent)
* [parserContextFlags](ts.labeledstatement.md#parsercontextflags)
* [pos](ts.labeledstatement.md#pos)
* [statement](ts.labeledstatement.md#statement)
* [symbol](ts.labeledstatement.md#symbol)
...
### label: [Identifier](ts.identifier.md)

* Defined in [lib/typescript/tsc.d.ts:745](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L745)
...
* Defined in [lib/typescript/tsc.d.ts:746](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L746)
