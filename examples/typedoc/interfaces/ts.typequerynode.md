...
### Properties
* [_typeNodeBrand](ts.typequerynode.md#_typenodebrand)
* [decorators](ts.typequerynode.md#decorators)
* [end](ts.typequerynode.md#end)
* [exprName](ts.typequerynode.md#exprname)
* [flags](ts.typequerynode.md#flags)
* [id](ts.typequerynode.md#id)
* [jsDocComment](ts.typequerynode.md#jsdoccomment)
* [kind](ts.typequerynode.md#kind)
* [localSymbol](ts.typequerynode.md#localsymbol)
* [locals](ts.typequerynode.md#locals)
* [modifiers](ts.typequerynode.md#modifiers)
* [nextContainer](ts.typequerynode.md#nextcontainer)
* [parent](ts.typequerynode.md#parent)
* [parserContextFlags](ts.typequerynode.md#parsercontextflags)
* [pos](ts.typequerynode.md#pos)
* [symbol](ts.typequerynode.md#symbol)
...
### exprName: [EntityName](../modules/ts.md#entityname)

* Defined in [lib/typescript/tsc.d.ts:504](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L504)
