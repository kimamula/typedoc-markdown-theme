...
### Properties
* [_statementBrand](ts.trystatement.md#_statementbrand)
* [catchClause](ts.trystatement.md#catchclause)
* [decorators](ts.trystatement.md#decorators)
* [end](ts.trystatement.md#end)
* [finallyBlock](ts.trystatement.md#finallyblock)
* [flags](ts.trystatement.md#flags)
* [id](ts.trystatement.md#id)
* [jsDocComment](ts.trystatement.md#jsdoccomment)
* [kind](ts.trystatement.md#kind)
* [localSymbol](ts.trystatement.md#localsymbol)
* [locals](ts.trystatement.md#locals)
* [modifiers](ts.trystatement.md#modifiers)
* [nextContainer](ts.trystatement.md#nextcontainer)
* [parent](ts.trystatement.md#parent)
* [parserContextFlags](ts.trystatement.md#parsercontextflags)
* [pos](ts.trystatement.md#pos)
* [symbol](ts.trystatement.md#symbol)
* [tryBlock](ts.trystatement.md#tryblock)
...
### Optional catchClause: [CatchClause](ts.catchclause.md)

* Defined in [lib/typescript/tsc.d.ts:753](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L753)
...
### Optional finallyBlock: [Block](ts.block.md)

* Defined in [lib/typescript/tsc.d.ts:754](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L754)
...
### tryBlock: [Block](ts.block.md)

* Defined in [lib/typescript/tsc.d.ts:752](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L752)
