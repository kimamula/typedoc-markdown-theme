...
### Properties
* [_statementBrand](ts.breakorcontinuestatement.md#_statementbrand)
* [decorators](ts.breakorcontinuestatement.md#decorators)
* [end](ts.breakorcontinuestatement.md#end)
* [flags](ts.breakorcontinuestatement.md#flags)
* [id](ts.breakorcontinuestatement.md#id)
* [jsDocComment](ts.breakorcontinuestatement.md#jsdoccomment)
* [kind](ts.breakorcontinuestatement.md#kind)
* [label](ts.breakorcontinuestatement.md#label)
* [localSymbol](ts.breakorcontinuestatement.md#localsymbol)
* [locals](ts.breakorcontinuestatement.md#locals)
* [modifiers](ts.breakorcontinuestatement.md#modifiers)
* [nextContainer](ts.breakorcontinuestatement.md#nextcontainer)
* [parent](ts.breakorcontinuestatement.md#parent)
* [parserContextFlags](ts.breakorcontinuestatement.md#parsercontextflags)
* [pos](ts.breakorcontinuestatement.md#pos)
* [symbol](ts.breakorcontinuestatement.md#symbol)
...
### Optional label: [Identifier](ts.identifier.md)

* Defined in [lib/typescript/tsc.d.ts:720](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L720)
