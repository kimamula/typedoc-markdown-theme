...
### Properties
* [block](ts.catchclause.md#block)
* [decorators](ts.catchclause.md#decorators)
* [end](ts.catchclause.md#end)
* [flags](ts.catchclause.md#flags)
* [id](ts.catchclause.md#id)
* [jsDocComment](ts.catchclause.md#jsdoccomment)
* [kind](ts.catchclause.md#kind)
* [localSymbol](ts.catchclause.md#localsymbol)
* [locals](ts.catchclause.md#locals)
* [modifiers](ts.catchclause.md#modifiers)
* [nextContainer](ts.catchclause.md#nextcontainer)
* [parent](ts.catchclause.md#parent)
* [parserContextFlags](ts.catchclause.md#parsercontextflags)
* [pos](ts.catchclause.md#pos)
* [symbol](ts.catchclause.md#symbol)
* [variableDeclaration](ts.catchclause.md#variabledeclaration)

## Properties

### block: [Block](ts.block.md)

* Defined in [lib/typescript/tsc.d.ts:758](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L758)
...
### variableDeclaration: [VariableDeclaration](ts.variabledeclaration.md)

* Defined in [lib/typescript/tsc.d.ts:757](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L757)
