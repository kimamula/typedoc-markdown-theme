...
### Properties
* [clauses](ts.caseblock.md#clauses)
* [decorators](ts.caseblock.md#decorators)
* [end](ts.caseblock.md#end)
* [flags](ts.caseblock.md#flags)
* [id](ts.caseblock.md#id)
* [jsDocComment](ts.caseblock.md#jsdoccomment)
* [kind](ts.caseblock.md#kind)
* [localSymbol](ts.caseblock.md#localsymbol)
* [locals](ts.caseblock.md#locals)
* [modifiers](ts.caseblock.md#modifiers)
* [nextContainer](ts.caseblock.md#nextcontainer)
* [parent](ts.caseblock.md#parent)
* [parserContextFlags](ts.caseblock.md#parsercontextflags)
* [pos](ts.caseblock.md#pos)
* [symbol](ts.caseblock.md#symbol)

## Properties

### clauses: [NodeArray](ts.nodearray.md)<[CaseOrDefaultClause](../modules/ts.md#caseordefaultclause)>

* Defined in [lib/typescript/tsc.d.ts:734](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L734)
