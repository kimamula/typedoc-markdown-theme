...
### Properties
* [_statementBrand](ts.block.md#_statementbrand)
* [decorators](ts.block.md#decorators)
* [end](ts.block.md#end)
* [flags](ts.block.md#flags)
* [id](ts.block.md#id)
* [jsDocComment](ts.block.md#jsdoccomment)
* [kind](ts.block.md#kind)
* [localSymbol](ts.block.md#localsymbol)
* [locals](ts.block.md#locals)
* [modifiers](ts.block.md#modifiers)
* [nextContainer](ts.block.md#nextcontainer)
* [parent](ts.block.md#parent)
* [parserContextFlags](ts.block.md#parsercontextflags)
* [pos](ts.block.md#pos)
* [statements](ts.block.md#statements)
* [symbol](ts.block.md#symbol)
...
* Defined in [lib/typescript/tsc.d.ts:684](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L684)
