...
### Properties
* [decorators](ts.decorator.md#decorators)
* [end](ts.decorator.md#end)
* [expression](ts.decorator.md#expression)
* [flags](ts.decorator.md#flags)
* [id](ts.decorator.md#id)
* [jsDocComment](ts.decorator.md#jsdoccomment)
* [kind](ts.decorator.md#kind)
* [localSymbol](ts.decorator.md#localsymbol)
* [locals](ts.decorator.md#locals)
* [modifiers](ts.decorator.md#modifiers)
* [nextContainer](ts.decorator.md#nextcontainer)
* [parent](ts.decorator.md#parent)
* [parserContextFlags](ts.decorator.md#parsercontextflags)
* [pos](ts.decorator.md#pos)
* [symbol](ts.decorator.md#symbol)
...
* Defined in [lib/typescript/tsc.d.ts:399](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L399)
