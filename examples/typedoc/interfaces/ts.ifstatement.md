...
### Properties
* [_statementBrand](ts.ifstatement.md#_statementbrand)
* [decorators](ts.ifstatement.md#decorators)
* [elseStatement](ts.ifstatement.md#elsestatement)
* [end](ts.ifstatement.md#end)
* [expression](ts.ifstatement.md#expression)
* [flags](ts.ifstatement.md#flags)
* [id](ts.ifstatement.md#id)
* [jsDocComment](ts.ifstatement.md#jsdoccomment)
* [kind](ts.ifstatement.md#kind)
* [localSymbol](ts.ifstatement.md#localsymbol)
* [locals](ts.ifstatement.md#locals)
* [modifiers](ts.ifstatement.md#modifiers)
* [nextContainer](ts.ifstatement.md#nextcontainer)
* [parent](ts.ifstatement.md#parent)
* [parserContextFlags](ts.ifstatement.md#parsercontextflags)
* [pos](ts.ifstatement.md#pos)
* [symbol](ts.ifstatement.md#symbol)
* [thenStatement](ts.ifstatement.md#thenstatement)
...
### Optional elseStatement: [Statement](ts.statement.md)

* Defined in [lib/typescript/tsc.d.ts:695](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L695)
...
* Defined in [lib/typescript/tsc.d.ts:693](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L693)
...
### thenStatement: [Statement](ts.statement.md)

* Defined in [lib/typescript/tsc.d.ts:694](https://github.com/kimamula/typedoc/blob/HEAD/src/lib/typescript/tsc.d.ts#L694)
